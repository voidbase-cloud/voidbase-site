// Cloudflare's unmodified logo (the devicons.io copy of the official artwork). Cloudflare's trademark page allows
// the name in word form for referential use and asks for written permission for the logo itself, so every caller
// can drop the mark and keep the wordmark.
export default function CloudflareMark() {
  return (
    <svg className="cf-mark" viewBox="0 0 128 128" aria-hidden="true">
