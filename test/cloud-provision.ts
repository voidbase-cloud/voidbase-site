...
//
// Run this only when the provisioning path itself changed: it creates and deletes a throwaway instance. The routine
// live proof is test/cloud-live.ts, the plugin lifecycle on the demo, which creates nothing.
//
