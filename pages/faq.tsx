// Ported from the SvelteKit site's (app)/faq page. The copy is PocketBase's own FAQ, carried over unchanged by the
// migration; rebranding it for voidbase is a separate pass.
...
export default function Faq() {
  ...
  <div className="page-content">
      <nav className="breadcrumbs">
          <div className="breadcrumb-item" data-pagefind-meta="title">FAQ</div>
      </nav>

      <div className="alert p-sm m-b-10">
          <div className="content">
              ...
              <p>
                  ...
                  <a href={SITE.benchmarksUrl} target="_blank" rel="noreferrer noopener">
                      benchmarks repo
                  </a>
                  .<br />
              ...
              <p>
                  ...
                  <a href={SITE.discussionsUrl} target="_blank" rel="noreferrer noopener"
                      >Discussions board</a
                  >,
                  <a href={SITE.repoUrl}>open an issue</a>
