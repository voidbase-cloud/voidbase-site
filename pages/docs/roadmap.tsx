  ...
  return (
    <article className="why">
      ...
      <Item
        ...
        now="The tiers exist in the manifest (core, official, community) and the loader reports a core interface nobody provides, but the core list is empty on purpose: nothing has left the core yet, and auth, the first candidate, is still built in. An installed plugin can already turn a shipped one off or take its place, which is the half of this that does not need auth to be a plugin first."
