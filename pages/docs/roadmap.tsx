  ...
  return (
    <article className="why">
      ...
      <Item
        ...
        now="Sign in with Cloudflare, name an instance, and it is created in your own account with its database, storage and domain. From its page you can upgrade it to the active release, install and remove plugins from any marketplace (a build the page shows), and delete it. Logs, metrics, domains, secrets and backups still live in Cloudflare's dashboard and the instance's own panel."
