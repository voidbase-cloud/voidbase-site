    ...
    <article className="why">
      ...
      <Versus
        ...
        rows={[
          ...
          { q: "Offline on the device", vb: ["depends", "The SDK's offline plugin: a write made without a network answers at once and replays on reconnect, and with its cache option the collections you name read from a local store before the network answers. Sync between devices is yours to build."], them: ["yes", "Writes queue on the device and reconcile. A decade of work behind it."] },
      ...
      <CostSection product="firebase" />
      <SpeedSection product="firebase" />
    </article>
  );
}
